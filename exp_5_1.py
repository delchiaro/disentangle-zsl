...
def main():
    model, train, test_unseen, test_seen, val = init_exp(build_model, gpu=0, seed=42)
    ...
    _, _, test_accs = exp(model, train, test_unseen,
                          ...
                          pretrain_cls_epochs=0, c_lr=.0001,
                          ...
                          test_period=1, test_epochs=10, test_lr=.0004, test_gen_samples=400,
